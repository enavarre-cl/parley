...
Lang Chat is an LLM chat editor inside VS Code. It runs in the extension host (Node) and a
...
- **Uncurated Piper voices.** If the user points `langChat.tts.piperModel` at their own `.onnx`,
